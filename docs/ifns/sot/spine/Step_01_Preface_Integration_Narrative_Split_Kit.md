# Step 01 – Preface Integration Narrative Split Kit

This file helps you break the **`01 Narrative & Intent`** page for **Step 01 – Preface Integration**
...
This step introduces IFNS as a **living system** and connects the visionary narrative

to the operational blueprint. It sets the mental model for the rest of the 14-step

spine and anchors the idea of the interface as a **Mirror of Financial Awareness**,

not just a traditional dashboard.
...
1. **Preface – 1. What this step does**
2. **Preface – 2. Who this step is for**
3. **Preface – 3. Key messages (must survive in all versions)**
4. **Preface – 4. Success criteria for Step 01**
...
### B.1 `Preface – 1. What this step does`

```markdown
# Preface – 1. What this step does
...
### B.2 `Preface – 2. Who this step is for`

```markdown
# Preface – 2. Who this step is for
...
### B.3 `Preface – 3. Key messages (must survive in all versions)`

```markdown
# Preface – 3. Key messages (must survive in all versions)
...
### B.4 `Preface – 4. Success criteria for Step 01`

```markdown
# Preface – 4. Success criteria for Step 01
