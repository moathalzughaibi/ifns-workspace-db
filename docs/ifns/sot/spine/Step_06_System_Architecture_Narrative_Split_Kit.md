# Step 06 – System Architecture Narrative Split Kit

This file helps you break the **`01 – Narrative & Intent`** page for **Step 06 – System Architecture**
...
This step defines the **System Architecture** of IFNS: the concrete components, flows, and environments

that turn the 14-step spine into a running system. Where Step 05 (Operational Genesis Framework) describes

*what* IFNS must be able to do, this step describes **how those roles are realized in structure**:
...
Use this page as a **map** only. The detailed architectural narrative now lives in the child pages below.

## Child pages

1. **Arch – 1. High-Level Architectural View**
2. **Arch – 2. Core Components and Their Responsibilities**
3. **Arch – 3. Environments and Deployment Lanes**
4. **Arch – 4. Data and Decision Flow**
5. **Arch – 5. SxE Integration Points**
6. **Arch – 6. Modularity and Extensibility**
...
### B.1 `Arch – 1. High-Level Architectural View`

```markdown
# Arch – 1. High-Level Architectural View
...
### B.2 `Arch – 2. Core Components and Their Responsibilities`
...
### B.3 `Arch – 3. Environments and Deployment Lanes`
...
### B.4 `Arch – 4. Data and Decision Flow`
...
### B.5 `Arch – 5. SxE Integration Points`

```markdown
# Arch – 5. SxE Integration Points
...
### B.6 `Arch – 6. Modularity and Extensibility`

```markdown
# Arch – 6. Modularity and Extensibility
