# IFNS Agent Onboarding Checklist (15‑Minute Read)
...
- [ ] Root DB retrieve PASS (see START HERE §3).
...
- [ ] I will not use heredocs or run Python code directly in PS—only `.py` or `-c` one‑liners.
