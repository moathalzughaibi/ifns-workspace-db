...
def number(n):
    return {n: {"number": {"format": "number"}}}


def relation(n, dbid):
    return {n: {"relation": {"database_id": dbid}}}
...
def seed_admin_rows(c, dbid):
    rows = [
        {
            "Name": {
                "title": [{"type": "text", "text": {"content": "Auto-refresh enabled"}}]
            },
            "Key": {
                "rich_text": [
                    {"type": "text", "text": {"content": "mirror.auto_refresh.enabled"}}
                ]
            },
            ...
            "Notes": {
                "rich_text": [{"type": "text", "text": {"content": "UI auto refresh"}}]
            },
        },
        {
            "Name": {
                "title": [
                    {"type": "text", "text": {"content": "Auto-refresh interval (s)"}}
                ]
            },
            "Key": {
                "rich_text": [
                    {
                        "type": "text",
                        "text": {"content": "mirror.auto_refresh.interval_s"},
                    }
                ]
            },
        ...
        },
        {
            ...
            "Key": {
                "rich_text": [
                    {"type": "text", "text": {"content": "harness.route.default"}}
                ]
            },
        ...
        },
        {
            ...
            "Key": {
                "rich_text": [
                    {"type": "text", "text": {"content": "harness.replay.speed"}}
                ]
            },
        ...
        {
            "Name": {
                "title": [{"type": "text", "text": {"content": "Min run minutes"}}]
            },
            "Key": {
                "rich_text": [
                    {"type": "text", "text": {"content": "harness.runs.min_minutes"}}
                ]
            },
        ...
        },
        {
            "Name": {
                "title": [
                    {"type": "text", "text": {"content": "Daily summary enabled"}}
                ]
            },
            "Key": {
                "rich_text": [
                    {"type": "text", "text": {"content": "reports.summary.enabled"}}
                ]
            },
            "Value": {"rich_text": [{"type": "text", "text": {"content": "true"}}]},
            "Type": {"select": {"name": "bool"}},
    ...
    for r in rows:
        c.pages.create(
            parent={"type": "database_id", "database_id": dbid}, properties=r
        )


def main():
    token = os.environ["NOTION_TOKEN"]
    root_db = os.environ["WORKSPACE_DB_ID"]
    if not token or not root_db:
        raise SystemExit("Missing NOTION_TOKEN/WORKSPACE_DB_ID")
    c = Client(auth=token)
