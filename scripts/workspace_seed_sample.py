...
def main():
    ...
    p = c.pages.create(
        parent={"database_id": P},
        properties={
            "Name": {"title": t("IFNS  Workspace bring-up")},
    ...
    c.pages.create(
        parent={"database_id": T},
        properties={
            "Name": {"title": t("Wire saved views & seed exporter")},
    ...
    c.pages.create(
        ...
        properties={
            "Name": {"title": t("Set SoT = Notion")},
            "Impact": {"select": {"name": "High"}},
        },
    )

    c.pages.create(
        parent={"database_id": A},
        properties={
            "Name": {"title": t("Approve workspace structure")},
            "Action": {"select": {"name": "approve"}},
        },
    )

    c.pages.create(
        parent={"database_id": H},
        properties={
            "Name": {"title": t("Workspace handover packet")},
